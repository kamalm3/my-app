...
const LendPageselected = () => {
  ...
  return (
    <div>
      <p> fr
        Select amount to lend to Vault: <input type="text" name="amount" value={formData.amount} onChange={handleChange} />
      </p>
      <br />
      <p>
...
export default LendPageselected;
